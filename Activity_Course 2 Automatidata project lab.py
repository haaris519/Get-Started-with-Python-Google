...
print(sorted_df[['trip_distance']].head(20))
...
print(sorted_df[[ 'total_amount']].head(20))
...
sorted_df = df.sort_values(by='trip_distance', ascending=False)
print(sorted_df[['trip_distance']].tail(20))
...
sorted_df = df.sort_values(by='total_amount', ascending=False)
print(sorted_df[[ 'total_amount']].tail(20))
...
credit_card_tip_avg = df[df['payment_type'] == 1]['tip_amount'].mean()
print("Average tip for trips paid with credit card:", credit_card_tip_avg)
cash_tip_avg = df[df['payment_type'] == 2]['tip_amount'].mean()
print("Average tip for trips paid with cash:", cash_tip_avg)
...
mean_total_amount_by_vendor = df.groupby('VendorID')['total_amount'].mean()
print("Mean total amount for each vendor:")
print(mean_total_amount_by_vendor)
...
passenger_count_credit_card = credit_card_payments['passenger_count']
print("Passenger count for credit card payments:")
print(passenger_count_credit_card)
...
credit_card_payments = df[df['payment_type'] == 1]
average_tip_by_passenger_count = credit_card_payments.groupby('passenger_count')['tip_amount'].mean()
